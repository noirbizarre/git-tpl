...
const DOCUMENTED: &[&str] = &[
    ...
    "tpl::manifest::parse",
    "tpl::migration::conflicting_message",
    "tpl::migration::duplicate_target",
    "tpl::migration::invalid_move",
    "tpl::migration::move_source_missing",
    "tpl::migration::move_target_exists",
    "tpl::migration::parse",
    "tpl::ops::already_initialised",
    "tpl::ops::invalid_argument",
    "tpl::ops::migration_file_not_utf8",
